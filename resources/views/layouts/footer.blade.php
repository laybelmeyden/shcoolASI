<footer class="container-fluid fh5co-footer">
    ...
    <div class="container-fluid copy">
        <div class="col-lg-12">
            <p>сайт разработан за счет средств субсидии, предоставленной ФГБУ «Роспатриотцентр» на реализацию проекта: «Интерактивная школа волонтеров краеведческой работы Сибирского федерального округа</p>
        </div>
    </div>